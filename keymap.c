...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[BASE_LAYER] = LAYOUT_65_ansi_blocker(
		    ...
		    KC_LCTL,                   KC_LGUI, KC_LALT,                     KC_SPC,            MO(FUNCTION_LAYER), TD(RCTL_TOGGLE_MAC), KC_LEFT, KC_DOWN,   KC_RIGHT),
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [RCTL_TOGGLE_MAC] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_RCTL, MAC_LAYER)
};